...
import com.panicDev.calendarview.R;
import com.panicDev.calendarview.format.ArrayWeekDayFormatter;
import com.panicDev.calendarview.format.DayFormatter;
import com.panicDev.calendarview.format.MonthArrayTitleFormatter;
import com.panicDev.calendarview.format.TitleFormatter;
import com.panicDev.calendarview.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
  ...
  /**
   * Set a {@linkplain com.panicDev.calendarview.format.WeekDayFormatter}
   * with the provided week day labels
   *
   * @param weekDayLabels Labels to use for the days of the week
   * @see com.panicDev.calendarview.format.ArrayWeekDayFormatter
   * @see #setWeekDayFormatter(com.panicDev.calendarview.format.WeekDayFormatter)
   */
  ...
  /**
   * Set a {@linkplain com.panicDev.calendarview.format.TitleFormatter}
   * using the provided month labels
   *
   * @param monthLabels month labels to use
   * @see com.panicDev.calendarview.format.MonthArrayTitleFormatter
   * @see #setTitleFormatter(com.panicDev.calendarview.format.TitleFormatter)
   */
